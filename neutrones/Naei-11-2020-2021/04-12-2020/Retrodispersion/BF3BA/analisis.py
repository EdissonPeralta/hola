...
for T in T_array:
        ...
        fondo = np.genfromtxt(path+file+'Fondo-130s.mtxt',skip_header=11,skip_footer=972)
        fuente = np.genfromtxt(path+file+'Cf252-130s.mtxt',skip_header=11,skip_footer=972)
