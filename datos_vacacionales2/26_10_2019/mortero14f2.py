...
datos2FM14=ascii.read('26-10-2019-PX5-HPGe-300s-fuentes2-14.MCA', data_start=0)

g=len(datos2FM14)

cuentas2FM14=np.zeros(g)
#canalM11=np.zeros(g)
ejeX2FM14=np.zeros(g)
for i in range(0,g):
    cuentas2FM14[i]=datos2FM14[i][0]
    #canal[i]=datos[i][0]
    ejeX2FM14[i]=i
...
M1=int(max(cuentas2FM14[1000:1120]))


for i in range(1000,1120):
	if cuentas2FM14[i]==M1:
		miu1=ejeX2FM14[i]

sigma1=math.sqrt(miu1)


cuentas1=cuentas2FM14[1000:1120]
eje1=ejeX2FM14[1000:1120]
...
M2=int(max(cuentas2FM14[1320:1420]))


for i in range(1320,1420):
	if cuentas2FM14[i]==M2:
		miu2=ejeX2FM14[i]

sigma2=math.sqrt(miu2)


cuentas2=cuentas2FM14[1320:1420]
eje2=ejeX2FM14[1320:1420]
...
#################### 22Na - 1274keV #####################
#########################################################
M3=int(max(cuentas2FM14[2620:2680]))


for i in range(2620,2680):
	if cuentas2FM14[i]==M3:
		miu3=ejeX2FM14[i]

sigma3=math.sqrt(miu3)


cuentas3=cuentas2FM14[2620:2680]
eje3=ejeX2FM14[2620:2680]
...
LIVE_MODE - 0
PRESET_TIME - 0
LIVE_TIME - 289.740000
REAL_TIME - 300.000000
START_TIME - 10/26/2019 10:45:45
SERIAL_NUMBER - 0
<<DATA>>
------------------------------------------------
