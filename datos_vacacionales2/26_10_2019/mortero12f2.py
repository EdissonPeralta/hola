...
datos2FM12=ascii.read('26-10-2019-PX5-HPGe-300s-fuentes2-12.MCA', data_start=0)

g=len(datos2FM12)

cuentas2FM12=np.zeros(g)
#canalM11=np.zeros(g)
ejeX2FM12=np.zeros(g)
for i in range(0,g):
    cuentas2FM12[i]=datos2FM12[i][0]
    #canal[i]=datos[i][0]
    ejeX2FM12[i]=i
...
M1=int(max(cuentas2FM12[1000:1120]))


for i in range(1000,1120):
	if cuentas2FM12[i]==M1:
		miu1=ejeX2FM12[i]

sigma1=math.sqrt(miu1)


cuentas1=cuentas2FM12[1000:1120]
eje1=ejeX2FM12[1000:1120]
...
M2=int(max(cuentas2FM12[1320:1420]))


for i in range(1320,1420):
	if cuentas2FM12[i]==M2:
		miu2=ejeX2FM12[i]

sigma2=math.sqrt(miu2)


cuentas2=cuentas2FM12[1320:1420]
eje2=ejeX2FM12[1320:1420]
...
M3=int(max(cuentas2FM12[2620:2680]))


for i in range(2620,2680):
	if cuentas2FM12[i]==M3:
		miu3=ejeX2FM12[i]

sigma3=math.sqrt(miu3)


cuentas3=cuentas2FM12[2620:2680]
eje3=ejeX2FM12[2620:2680]
...
LIVE_MODE - 0
PRESET_TIME - 0
LIVE_TIME - 288.630000
REAL_TIME - 300.000000
START_TIME - 10/26/2019 10:33:50
SERIAL_NUMBER - 0
<<DATA>>
