...
datos1FM41=ascii.read('31-10-2019-PX5-HPGe-1200s-fuentes1-41.MCA', data_start=0)

g=len(datos1FM41)

cuentas1FM41=np.zeros(g)
#canalM11=np.zeros(g)
ejeX1FM41=np.zeros(g)
for i in range(0,g):
    cuentas1FM41[i]=datos1FM41[i][0]
    #canal[i]=datos[i][0]
    ejeX1FM41[i]=i
...
M1=int(max(cuentas1FM41[140:200]))


for i in range(140,200):
	if cuentas1FM41[i]==M1:
		miu1=ejeX1FM41[i]

sigma1=math.sqrt(miu1)


cuentas1=cuentas1FM41[140:200]
eje1=ejeX1FM41[140:200]
...
M2=int(max(cuentas1FM41[240:263]))


for i in range(240,263):
	if cuentas1FM41[i]==M2:
		miu2=ejeX1FM41[i]

sigma2=math.sqrt(miu2)


cuentas2=cuentas1FM41[240:263]
eje2=ejeX1FM41[240:263]
...
M3=int(max(cuentas1FM41[270:291]))


for i in range(278,291):
	if cuentas1FM41[i]==M3:
		miu3=ejeX1FM41[i]

sigma3=math.sqrt(miu3)


cuentas3=cuentas1FM41[278:291]
eje3=ejeX1FM41[278:291]
...
M4=int(max(cuentas1FM41[620:640]))


for i in range(620,640):
	if cuentas1FM41[i]==M4:
		miu4=ejeX1FM41[i]

sigma4=math.sqrt(miu4)


cuentas4=cuentas1FM41[620:640]
eje4=ejeX1FM41[620:640]
...
M5=int(max(cuentas1FM41[734:747]))


for i in range(734,747):
	if cuentas1FM41[i]==M5:
		miu5=ejeX1FM41[i]

sigma5=math.sqrt(miu5)


cuentas5=cuentas1FM41[734:747]
eje5=ejeX1FM41[734:747]
...
M6=int(max(cuentas1FM41[780:820]))


for i in range(780,820):
	if cuentas1FM41[i]==M6:
		miu6=ejeX1FM41[i]

sigma6=math.sqrt(miu6)


cuentas6=cuentas1FM41[780:820]
eje6=ejeX1FM41[780:820]
...
M7=int(max(cuentas1FM41[2425:2450]))


for i in range(2425,2450):
	if cuentas1FM41[i]==M7:
		miu7=ejeX1FM41[i]

sigma7=math.sqrt(miu7)


cuentas7=cuentas1FM41[2425:2450]
eje7=ejeX1FM41[2425:2450]
...
M8=int(max(cuentas1FM41[2760:2780]))


for i in range(2760,2780):
	if cuentas1FM41[i]==M8:
		miu8=ejeX1FM41[i]

sigma8=math.sqrt(miu8)


cuentas8=cuentas1FM41[2760:2780]
eje8=ejeX1FM41[2760:2780]
...
START_TIME - 10/31/2019 16:00:20
SERIAL_NUMBER - 0
<<DATA>>
----------------------------------------------------
<<END>>
