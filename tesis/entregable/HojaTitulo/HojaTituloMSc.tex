...
Estudio de materiales de construcción a partir de simulación Monte Carlo, transmisión y retrodispersión de rayos gamma.}\\[4.0cm]
\Large\textbf{Edisson Leonardo Peralta Bernal.}\\[4.0cm]
...
Estudio de materiales de construcción a partir de simulación Monte Carlo, transmisión y retrodispersión de rayos gamma}\\[2.5cm]
\Large\textbf{Edisson Leonardo Peralta Bernal}\\[2.5cm]
\small Trabajo de grado presentado como requisito parcial para optar al
t\'{\i}tulo de:\\
\textbf{Físico}\\[2.5cm]
Director:\\
Ph.D. Fernando Cristancho Mejía\\[2.0cm]
L\'{\i}nea de Investigaci\'{o}n:\\
Física Nuclear\\
Grupo de Investigaci\'{o}n:\\
Grupo de Física Nuclear de la Universidad Nacional de Colombia (GFNUN)\\[2.5cm]
