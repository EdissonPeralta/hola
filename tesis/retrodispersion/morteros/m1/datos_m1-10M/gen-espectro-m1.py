...
ax.plot(x13,espectro13,drawstyle='steps-mid',label='13 cm')
...
plt.text(8.0,0.3,r'Geant4: $\mu_T$=0.159(6)$\frac{cm^2}{g}$', size=15)
plt.text(8.0,0.2,r'NIST: $\mu_T$=0.257$\frac{cm^2}{g}$', size=15)
plt.text(8.0,0.1,r'Discrepancia: 38.1$\%$', size=15)
