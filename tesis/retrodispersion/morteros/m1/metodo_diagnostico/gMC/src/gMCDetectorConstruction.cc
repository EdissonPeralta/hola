...
// Na2O :: Sodium oxide
  ...
  /*
  ///////////////////////////////////////////////////////////////////////////////
  //Creation of the cement board number 2
  ///////////////////////////////////////////////////////////////////////////////
  
  G4Box* placaSolid2 = new G4Box("placa2", placa_hx, placa_hy, placa_hz);
  fPlacaLogical2 = new G4LogicalVolume(placaSolid2, Morteros1,"placaLogical2");

  G4ThreeVector Tplaca2;    
  G4Transform3D T3Dplaca2;
  Tplaca2.setX(4.5*cm);  Tplaca2.setY(0.0*cm);
  G4double zPlaca2 = - 4*placa_hz + placa_hz - 2.0*cm;
  Tplaca2.setZ(zPlaca2);
  T3Dplaca2 = G4Transform3D(R0,Tplaca2);    
  new G4PVPlacement(T3Dplaca2,
  		    fPlacaLogical2,
  		    "placaPhysical2",
  		    worldLogical,
  		    false,0,checkOverlaps);
  ...
  */  
  ...
  visAttributes = new G4VisAttributes(G4Colour(0.,0.,0.7));
  ...
  visAttributes->SetVisibility(true);
  visAttributes->SetForceSolid(true);
  fPlacaLogical2->SetVisAttributes(visAttributes);
  fVisAttributes.push_back(visAttributes);
  */
  visAttributes = new G4VisAttributes(G4Colour(0.7,0.6,0.7));
  visAttributes->SetVisibility(true);
