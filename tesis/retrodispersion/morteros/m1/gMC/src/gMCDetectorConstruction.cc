...
// Na2O :: Sodium oxide
  ...
  Morteros1 = new G4Material("Morteros1", density= 2.080*g/cm3, nElem=9);

  Morteros1->AddMaterial(SiO2, fractionMass=36.58536*perCent);
  Morteros1->AddMaterial(water, fractionMass=24.39024*perCent);
  Morteros1->AddMaterial(CaO, fractionMass=23.20369.19464*perCent);
  ...
  G4double placa_hz = 20.0*cm; // the variation is 0.1
