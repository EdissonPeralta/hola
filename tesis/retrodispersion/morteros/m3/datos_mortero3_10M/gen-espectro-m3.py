...
plt.text(Xsaturacion + 0.1, 0.7, r'9.7852(agregar) cm', size=15, color='navy')


axs.set_xlabel(r'$t$ (cm)', size=20)
axs.set_ylabel('Intensidad (cuentas)', size=20)
plt.text(10.0,0.3,r'Geant4: $\mu_T$=0.145(8)$\frac{cm^2}{g}$', size=15)
plt.text(10.0,0.2,r'NIST: $\mu_T$=0.253$\frac{cm^2}{g}$', size=15)
plt.text(10.0,0.1,r'Discrepancia: 42.6$\%$', size=15)
