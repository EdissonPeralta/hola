...
// Na2O :: Sodium oxide
  ...
  Morteros1 = new G4Material("Morteros1", density= 1.6249*g/cm3, nElem=9);

  Morteros1->AddMaterial(SiO2, fractionMass=70.42253*perCent);
  Morteros1->AddMaterial(water, fractionMass=14.0845*perCent);
  Morteros1->AddMaterial(CaO, fractionMass=9.21202*perCent);
  Morteros1->AddMaterial(Fe2O3, fractionMass=2.09364*perCent); 
  Morteros1->AddMaterial(Al2O3, fractionMass=1.25618*perCent);
  Morteros1->AddMaterial(MgO, fractionMass=1.25618*perCent); 
  Morteros1->AddMaterial(SO3, fractionMass=1.25618*perCent);
  Morteros1->AddMaterial(K2O, fractionMass=0.2931*perCent); 
  Morteros1->AddMaterial(Na2O, fractionMass=0.12562*perCent);;
  
  // Dimension of the cement board
  G4double placa_hx = 4.7787*cm; // 9,5575
  G4double placa_hy = 4.8692*cm; // 9,7385 
