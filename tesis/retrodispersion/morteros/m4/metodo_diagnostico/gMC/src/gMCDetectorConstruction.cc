...
// Na2O :: Sodium oxide
  ...
  G4double placa_hx = 4.78705*cm; // 9,5741
  G4double placa_hy = 4.8658*cm; // 9,7317 
  ...
  G4double desplazamiento= 8.0*cm; //Aca se regula el dezplazamiento en x para barrer el mortero. Se hace desde 8.0 hasta -1.0 de a 0.5
