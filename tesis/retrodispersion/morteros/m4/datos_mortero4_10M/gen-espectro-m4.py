...
plt.text(8.0,0.3,r'Geant4: $\mu_T$=0.152(6)$\frac{cm^2}{g}$', size=15)
plt.text(8.0,0.2,r'NIST: $\mu_T$=0.252$\frac{cm^2}{g}$', size=15)
plt.text(8.0,0.1,r'Discrepancia: 39.6$\%$', size=15)
