...
f1 = np.genfromtxt('gMC_h1_NaI1.csv',delimiter=',')
f2 = np.genfromtxt('gMC_h1_NaI2.csv',delimiter=',')
f3 = np.genfromtxt('gMC_h1_NaI3.csv',delimiter=',')
f4 = np.genfromtxt('gMC_h1_NaI4.csv',delimiter=',')
f5 = np.genfromtxt('gMC_h1_NaI5.csv',delimiter=',')
f6 = np.genfromtxt('gMC_h1_NaI6.csv',delimiter=',')
f7 = np.genfromtxt('gMC_h1_NaI7.csv',delimiter=',')
f8 = np.genfromtxt('gMC_h1_NaI8.csv',delimiter=',')
f9 = np.genfromtxt('gMC_h1_NaI9.csv',delimiter=',')
f10 = np.genfromtxt('gMC_h1_NaI10.csv',delimiter=',')
f11 = np.genfromtxt('gMC_h1_NaI11.csv',delimiter=',')
f12 = np.genfromtxt('gMC_h1_NaI12.csv',delimiter=',')
...
propaga_error_x=[0.005,0.005,0.005,0.005,0.005,0.005,0.005,0.005,0.005,0.005,0.005,0.005]
...
plt.text(9.5, 0.7, r'9.3(7) cm', color='navy')
...
plt.ylim(0,1.15)
#plt.grid(True)
leg=axs.legend(loc="upper left")#, bbox_to_anchor=(1, 1.05))
#for legobj in leg.legendHandles: #tamaño de la leyenda
#    legobj.set_linewidth(2.0) #tamaño de la leyenda
fig2.tight_layout()
#fig2.savefig('mu_T-m2.pdf')
plt.show()
