...
max11=int(max(espectro11[657:665]))


for i in range(657,665):
    if espectro11[i]==max11:
        mu11=x11[i]

sig11= 0.425 * FWHM_Ge(mu11)

cuentas11=espectro11[657:665]
eje11=x11[657:665]

a0_11=1
a1_11=1
def gaussi11(t,max11,mu11,sig11,a1_11,a0_11):
	return max11*(np.exp(-((mu11-t)**2)/((math.sqrt(2)*sig11)**2)))+((a1_11*t)+a0_11)

popt_gaussi11, pcov11=curve_fit(gaussi11, eje11, cuentas11, p0=[max11,mu11,sig11,a1_11,a0_11])

errores11= np.sqrt(np.diag(pcov11))


max11=popt_gaussi11[0]
mu11=popt_gaussi11[1]
sig11=popt_gaussi11[2]
a1_11=popt_gaussi11[3]
a0_11=popt_gaussi11[4]

print('nuevas cuentas 11')
cuentas11=math.sqrt(2*math.pi)*max11*sig11
print(cuentas11)


errores_max11=errores11[0]
errores_sig11=errores11[2]

incer11=cuentas11*math.sqrt((errores_max11/max11)**2+(errores_sig11/sig11)**2)
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
ax.plot(x1,espectro1,drawstyle='steps-mid',label='0 cm')
ax.plot(x2,espectro2,drawstyle='steps-mid',label='0.2 cm')
ax.plot(x3,espectro3,drawstyle='steps-mid',label='0.4 cm')
ax.plot(x4,espectro4,drawstyle='steps-mid',label='0.6 cm')
ax.plot(x5,espectro5,drawstyle='steps-mid',label='0.8 cm')
ax.plot(x6,espectro6,drawstyle='steps-mid',label='1.0 cm')
ax.plot(x7,espectro7,drawstyle='steps-mid',label='1.2 cm')
ax.plot(x8,espectro8,drawstyle='steps-mid',label='1.4 cm')
ax.plot(x9,espectro9,drawstyle='steps-mid',label='1.6 cm')
ax.plot(x10,espectro10,drawstyle='steps-mid',label='1.8 cm')
ax.plot(x11,espectro11,drawstyle='steps-mid',label='2,0 cm')
